    ...
    slides: [
      {
        ...
        <div class="img-compare"><div class="img-compare-inner"><img class="img-compare-after" src="/images/hana-after.png" alt="Mural canvas after Project Hana" /><img class="img-compare-before" id="hana-compare-before" src="/images/hana-situation.png" alt="Mural canvas before Project Hana" style="clip-path:inset(0 0 0 20%)" /><div class="img-compare-handle" id="hana-compare-handle" style="left:20%"></div><span class="img-compare-label img-compare-label-l">Before</span><span class="img-compare-label img-compare-label-r">After</span><input type="range" min="0" max="100" value="20" class="img-compare-range" oninput="document.getElementById('hana-compare-before').style.animation='none';document.getElementById('hana-compare-handle').style.animation='none';document.getElementById('hana-compare-before').style.clipPath='inset(0 0 0 '+this.value+'%)';document.getElementById('hana-compare-handle').style.left=this.value+'%'" /></div><div class="img-caption">Project Hana — Before &amp; After · Drag to compare</div></div>`,
      },
      {
        label: "The Risk",
